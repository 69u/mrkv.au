...
- Setup, Deboard and Managed devices & servers using Datto RMM, Backupify and Microsoft's Deployment Toolkit
- Talked with clients in tickets using Datto AutoTask
- Managed client orders using Datto Commerce.
- Windows Server (Active Directory, Group Policy, Powershell, MDT)
- Office 365 Administration (Azure AD, Local AD, Exchange, Teams, SharePoint, Endpoints)
...
- Provided Remote and On-site support for clients
