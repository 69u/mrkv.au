...
I started my career as a systems engineer intern for a local IT company in early 2022 and in late 2022, I resigned from my position to focus on completing college matters while taking on some freelance projects - I've tried some programming languages and tech stack, both Back-End, and Front-End.
...
I love creating resources for people that are clean, minimalistic, attractive and that have value and of course, that are easy to use.
...
<VStack spacing={12}>
  ...
  <HStack spacing={8}>
    <Label indicator={100}>Vue</Label>
    <Label indicator={50}>Nuxt.js</Label>
