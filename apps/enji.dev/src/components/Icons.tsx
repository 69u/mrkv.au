...
export function VueIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px" {...props}>
      <polygon fill="currentColor" points="23.987,17 18.734,8 2.974,8 23.987,44 45,8 29.24,8"/>
      <polygon fill="currentColor" points="29.24,8 23.987,17 18.734,8 11.146,8 23.987,30 36.828,8"/>
...
export function LaravelIcon(props: ComponentProps<'svg'>) {
  return (
    <svg height="24" viewBox="0 -.11376601 49.74245785 51.31690859" width="24" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function NuxtJSIcon(props: ComponentProps<'svg'>) {
  return (
    <svg width="24" height="24" viewBox="0 0 61 40" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function NodeJSIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 232" {...props}>
      <path fill="currentColor" d="M128 0C57.308 0 0 57.308 0 128s57.308 128 128 128 128-57.308 128-128S198.692 0 128 0zm55.391 179.287c-2.924 1.689-6.105 2.535-9.597 2.535-3.489 0-6.67-.846-9.597-2.535l-25.196-14.552V95.391l25.196-14.552c5.843-3.373 13.349-3.373 19.195 0l25.196 14.552v69.344l-25.197 14.552zm-102.782 0c-2.924 1.689-6.105 2.535-9.597 2.535-3.489 0-6.67-.846-9.597-2.535L36.22 164.734V95.391L61.416 80.839c5.843-3.373 13.349-3.373 19.195 0l25.196 14.552v69.344l-25.197 14.552z"/>
